	...
	function SetQuery($query){
		...
		echo "<table border=1 bordercolor=#84ADEE cellspacing=0 cellpadding=0 background=fon.jpg width=95% bgcolor=#E7EBEB><tr>";
			...
			echo "	<body vlink=blue alink=blue link=blue>
					<th bgcolor=black><font color=white face=verdana size=2 color=white>C&oacute;digo</th>
					...
					<th bgcolor=black><font color=white face=verdana size=2 color=white>Tel&eacute;fono</th>
					";
