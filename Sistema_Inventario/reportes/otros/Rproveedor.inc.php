	...
	function SetQuery($query){
		...
		echo "<table border=1 bordercolor=#84ADEE cellspacing=0 cellpadding=0 background=fon.jpg width=100%><tr bgcolor=#610B0B>";
			...
			echo "	<body vlink=blue alink=blue link=blue>
					...
					<th><font color=white face=verdana size=2>Direccion</th>
					<th><font color=white face=verdana size=2>Contacto</th>
					<th><font color=white face=verdana size=2>Tel&eacute;fono</th>
					<th><font color=white face=verdana size=2>Celular</th>
					";
