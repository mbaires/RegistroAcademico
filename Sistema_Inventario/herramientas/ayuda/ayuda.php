...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_menu">
        <ul>
            ...
            <li><a href="../home.php"><span></span><b>SISTEMA</a></li>
            <li><a href="./usuarios.php" class="current"><span></span><b>USUARIOS</a></li>
			<li><a href="../consultas/Consultas.php" ><span></span><b>CONSULTAS</a></li>
			<li><a href="../reportes/reportes.php" ><span></span><b>REPORTES</a></li>
            <li><a href="./respaldosBD.php"><span></span><b> RESPALDO</a></li>
    ...
    <div id="templatemo_main">
		...
		<div class="sidebar_box">
                ...
                <ul class="sidebar_menu">
                    ...
                    <li><a href="./ayuda/ayuda.php" target="contenido">&raquo; AYUDA</a></li>
