...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_header">
        ...
        <div id="site_title">
            <a><span><font style="font-style:italic" >Sistema 
            	de Inventario y Facturaci&oacute;n</font></span>
    ...
    <div id="templatemo_menu">
        <ul>
            ...
            <li><a href="./respaldosBD.php" class="current">RESPALDO</a></li>
    ...
    <div id="templatemo_main">
		...
		<div class="sidebar_box">
                ...
                <ul class="sidebar_menu">
                    ...
                    <li><a href="./crear_backup.php" target="contenido">&raquo; CREAR COPIAS DE RESPALDO </a></li>
                    <li><a href="./restaurar_backup.php" target="contenido">&raquo; RESTAURAR COPIAS</a></li>
