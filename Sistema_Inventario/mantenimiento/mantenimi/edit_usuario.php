					...
					else
					{
						...
						$nregistros=$nregistros + 1;
							echo "<tr onMouseOver=\"uno(this,'#99CCFF');\" onMouseOut=\"dos(this,'FFFFFF');\">
								...
								<td class=text><center>$datos[Password]
...
if(@$_GET["id"])
{
	...
	<td><input name=nombre type=text value='$extraer[Login]' readonly>
	<tr>
	<td><font face=arial size=2><b>Password:
	<td><input name=pass type=password value=$extraer[Password]>
	<tr>
...
{
	include("../mysql.php");
	$registros=mysql_query("Select * from Usuarios where Password='$_POST[pass]'");
		if(mysql_num_rows($registros)==0)
		{
		  $contrasena=md5("$_POST[pass]");
			if(mysql_query("Update Usuarios Set Login='$_POST[nombre]',Password='$contrasena',DUI='$_POST[dui]',
