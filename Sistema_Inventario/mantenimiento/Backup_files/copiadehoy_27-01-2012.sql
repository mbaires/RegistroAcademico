...
INSERT INTO `compras` VALUES (1,1,50,'1.00','24-01-2012',1,'cuadernos rayados'),(2,2,50,'0.20','25-01-2012',1,'lapiceros azules'),(3,3,87,'2.00','27-01-2012',1,'lapiz');
UNLOCK TABLES;
...
INSERT INTO `facturas` VALUES (1,'Lainez','san miguel',0,'26-01-12','anulado'),(2,'karla romero','san miguel',0,'26-01-12','Contado'),(3,'segovia','mercedes',0,'27-01-12','Contado');
UNLOCK TABLES;
...
INSERT INTO `inventario` VALUES (1,'cuadernos','facela','rayado','','1.03',47),(2,'lapicero','bic','mediano','azul','0.21',50),(3,'lapiz','facela','pequeño','','2.06',87);
UNLOCK TABLES;
...
INSERT INTO `proveedores` VALUES ('1','medalla milagrosa','San Miguel','Pedro Jose','2342-3424','7423-4234','jose_pedro@hotmail.com');
UNLOCK TABLES;
...
INSERT INTO `usuarios` VALUES (1,'administrador','sistema04','000001','administrador'),(2,'Alfredo','lainez','00566464-5','usuario'),(3,'segoviad','hola','00454545-4','usuario');
UNLOCK TABLES;
...
INSERT INTO `ventas` VALUES (1,1,2,5,'0.21'),(2,2,1,2,'1.03'),(3,3,1,1,'1.03');
UNLOCK TABLES;
